...
exports.createDemoUser = void 0;
const User_1 = __importDefault(require("../models/User"));
const Task_1 = __importDefault(require("../models/Task"));
const createDemoUser = async () => {
    try {
        const demoEmail = 'VijjuProMax@demo.com';
        const existingUser = await User_1.default.findOne({ email: demoEmail });
        let demoUser;
        if (!existingUser) {
            demoUser = new User_1.default({
                email: demoEmail,
        ...
        const existingTasks = await Task_1.default.find({ userId: demoUser._id });
        if (existingTasks.length === 0) {
            ...
            await Task_1.default.insertMany(demoTasks);
...
//# sourceMappingURL=createDemoUser.js.map